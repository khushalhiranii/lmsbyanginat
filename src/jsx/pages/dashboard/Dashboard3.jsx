                ...
                <div className="col-sm-6 col-xl-3">
                    <div className="widget-stat card bg-success overflow-hidden">
                        <div className="card-header border-opacity">
                            ...
                            <h5 className="text-white mb-0"><i className="fa fa-caret-up"></i> 357</h5>
                        </div>
                ...
                <div className="col-sm-6 col-xl-3">
                    <div className="widget-stat card bg-secondary overflow-hidden">
                        <div className="card-header border-opacity pb-3">
                            ...
                            <h5 className="text-white mb-0"><i className="fa fa-caret-up"></i> 547</h5>
                        </div>
                        <div className="card-body p-0 mt-2">
                            <div className="px-4">
                                {/* <span className="bar1" data-peity='{ "fill": ["rgb(0, 0, 128)", "rgb(7, 135, 234)"]}'>6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span> */}
                                <TotalCourse />
