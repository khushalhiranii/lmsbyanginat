		...
		<div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
			...
			<div className="sidebar-right-inner">
				...
				<div className="note-text">
					...
					<Link to={"https://edumin.dexignlab.com/react/doc"} target="_blank" className="text-primary"> documentation.</Link>
				</div>
			</div>
		</div>
					...
					<div className="dlab-wrapper row">
						...
						<div className="col-xl-3 col-md-6 mb-4">
							<div className="overlay-bx dlab-demo-bx ">
								...
								<div className="overlay-layer">
									<Link to={"#"} onClick={() => {setDemoTheme(7,'ltr'); setDemoToggle(!demoToggle)}} data-theme="7" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
								</div>
							</div>
							<h5 className="text-white">Demo 7</h5>
						</div>
						<div className="col-xl-3 col-md-6 mb-4">
							<div className="overlay-bx dlab-demo-bx ">
								<div className="overlay-wrapper rounded-lg"><img src={demo8} alt="" className="w-100" /></div>
								<div className="overlay-layer">
									<Link to={"#"} onClick={() => {setDemoTheme(8,'ltr'); setDemoToggle(!demoToggle)}} data-theme="8" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
								</div>
							</div>
							<h5 className="text-white">Demo 8</h5>
						</div>
					</div>
				</div>	
